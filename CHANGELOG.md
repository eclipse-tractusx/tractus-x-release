...
- Currently there is not possible to issue the membership credential as defined in the CX-0050 standard from Catena-X, because of a missing feature in upstream: ['936](Possible BUG: JWT credential @context is hardcoded and not configurable via CredentialDefinition API)
